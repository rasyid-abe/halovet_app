                ...
                <div class="page-inner">
                 <a href="{{ url('adminix/page') }}" class="btn btn-md btn-primary">Kembali ke Daftar Halaman</a>
                    ...
                    <div class="page-title">
                        <h3 class="breadcrumb-header">Buat Halaman Baru</h3>
                    </div>
                    ...
                    <div class="col-md-12">
                     <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                     <form class="form-horizontal" method="post" action="{{ url('adminix/page/new/save') }}"  enctype="multipart/form-data">
                              {{ csrf_field() }}
...
<div class="form-group">
  ...
  <div class="col-md-10">
  <input id="textinput" name="pagejudul" placeholder="masukan judul halaman" class="form-control" type="text">
  </div>
</div>

<div class="form-group">
  <label class="col-md-2 control-label" for="textinput">Isi Halaman</label>  
  <div class="col-md-10">
...
<div class="form-group">
<label class="control-label col-md-2" for="slidimg">Gambar BG </label>
<div class="col-md-10">
