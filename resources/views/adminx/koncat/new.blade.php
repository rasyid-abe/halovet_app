                    ...
                    <div class="col-md-12">
                     <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                     <form class="form-horizontal" method="post" action="{{ url('adminix/konsultasi/category/new/save') }}"  enctype="multipart/form-data">
                              {{ csrf_field() }}
...
<div class="form-group">
  ...
  <div class="col-md-10">
  <input id="textinput" name="koncatjudul" placeholder="masukan nama kategori" class="form-control" type="text">
  </div>
</div>
