                ...
                <div class="page-inner">
                 <a href="{{ url('adminix/slider') }}" class="btn btn-md btn-primary">Kembali ke Daftar Slider</a>
                    ...
                    <div class="page-title">
                        <h3 class="breadcrumb-header">Buat Slider Baru</h3>
                    </div>
                    ...
                    <div class="col-md-12">
                     <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Slider Baru</h4>
                                </div>
                                <div class="panel-body">
                                     <form class="form-horizontal" method="post" action="{{ url('adminix/slider/new/save') }}"  enctype="multipart/form-data">
                              {{ csrf_field() }}
...
<div class="form-group">
  ...
  <div class="col-md-10">
  <input id="textinput" name="slidjudul" placeholder="masukan judul slider" class="form-control" type="text">
  </div>
</div>
...
<div class="col-md-10">
<img src="" id="slidimg" style="max-width:700px;max-height:300px;" />

<input type="file" id="slidimg" name="slidimg" class="validate" >
</div>
</div>
<div class="form-group">
<label class="control-label col-md-2" for="slidbg">Gambar </label>
<div class="col-md-10">
<img src="" id="slidbg" style="max-width:700px;max-height:300px;" />
