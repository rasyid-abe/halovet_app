                ...
                <div class="page-inner">
                 <a href="{{ url('adminix/penyakit/') }}" class="btn btn-md btn-primary">Kembali ke Daftar Penyakit</a>
                    ...
                    <div class="page-title">
                        <h3 class="breadcrumb-header">Buat Penyakit Baru</h3>
                    </div>
                    ...
                    <div class="col-md-12">
                     <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Penyakit Baru</h4>
                                </div>
                                <div class="panel-body">
                                     <form class="form-horizontal" method="post" action="{{ url('adminix/penyakit/new/save') }}"  enctype="multipart/form-data">
                              {{ csrf_field() }}
...
<div class="form-group">
  ...
  <div class="col-md-10">
  <input id="textinput" name="pennama" placeholder="masukan nama penyakit" class="form-control" type="text">
  </div>
</div>
