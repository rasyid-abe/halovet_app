...
@section('title','Ubah Lowongan Pekerjaan -')
@section('content')
                ...
                <div class="page-inner">
                 <a href="{{ url('adminix/loker/') }}" class="btn btn-md btn-primary">Kembali ke Daftar Lowongan</a>
                    ...
                    <div class="page-title">
                        <h3 class="breadcrumb-header">Ubah Lowongan Pekerjaan</h3>
                    </div>
                    ...
                    <div class="col-md-12">
                     <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">{{$lkedit->lokjudul}}</h4>
                                </div>
                                <div class="panel-body">
                                     <form class="form-horizontal" method="post" action="{{ url('adminix/loker/edit/save') }}"  enctype="multipart/form-data">
                              {{ csrf_field() }}

<fieldset>

<input type="hidden" name="lokid" value="{{$lkedit->lokid}}">
<!-- Text input-->
<div class="form-group">
  <label class="col-md-2 control-label" for="textinput">Judul Lowongan Pekerjaan</label>  
  <div class="col-md-10">
  <input id="textinput" name="lokjudul" value="{{$lkedit->lokjudul}}" class="form-control" type="text">
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-10">
  <input id="textinput" name="lokperus" value="{{$lkedit->lokperus}}" class="form-control" type="text">
  </div>
</div>
...
<div class="col-md-10">
<img src="{{ asset($lkedit->lokimg) }}" id="blah" style="max-width:700px;max-height:300px;" />
