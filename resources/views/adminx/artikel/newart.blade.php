                ...
                <div class="page-inner">
                 <a href="{{ url('adminix/artikel/kategori') }}" class="btn btn-md btn-primary">Kembali ke Daftar Artikel</a>
                    ...
                    <div class="page-title">
                        <h3 class="breadcrumb-header">Buat Artikel Baru</h3>
                    </div>
                    ...
                    <div class="col-md-12">
                     <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Artikel Baru</h4>
                                </div>
                                <div class="panel-body">
                                     <form class="form-horizontal" method="post" action="{{ url('adminix/artikel/new/save') }}"  enctype="multipart/form-data">
                              {{ csrf_field() }}
...
<div class="form-group">
  ...
  <div class="col-md-10">
 <textarea name="isi" id="editor" class="editor">
</textarea>
  </div>
</div>
<div class="form-group">
