...
@endsection
 <!-- Page Inner -->
                <div class="page-inner">
                 <a href="{{ url('adminix/jawabandiskusi') }}" class="btn btn-md btn-primary">Kembali ke Daftar Jawaban</a>

                    <div class="page-title">
                        <h3 class="breadcrumb-header">Ubah Jawaban #{{$ej->jawid}}</h3>
                        <h5>Pada thread <a href="{{ url('konsultasi/'.$ej->konsslug) }}">{{$ej->konsjudul}}</a></h5>
                    </div>
                    ...
                    <div class="col-md-12">
                     <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                     <form class="form-horizontal" method="post" action="{{ url('adminix/jawabandiskusi/edit/save') }}"  enctype="multipart/form-data">
                              {{ csrf_field() }}
...
<div class="form-group">
  <label class="col-md-2 control-label" for="textinput">Isi Jawaban</label>  
  <div class="col-md-10">
 <textarea name="jawisi" id="editor">
 {!! $ej->jawisi !!}
</textarea>
  </div>
</div>
