...
class KonsultasiController extends Controller
{
    public function konsultasip()
    {
    	...
    	return view('threadlist')->with(compact('kindex','randart','randoc','randpen'));
    }
    ...
    public function newkonsul()
    {
        ...
        $randoc = u::inRandomOrder()->paginate(2);
        $randpen = p::inRandomOrder()->paginate(5);
    	return view('newkonsul')->with(compact('kc','randart','randoc','randpen'));
    }
  ...
  $msg = notify()->flash('Berhasil ! Pertanyaan anda berhasil diterbitkan', 'alert');
    ...
    public function viewkonsul($slug)
    {
        ...
        $randoc = u::inRandomOrder()->paginate(2);
        $randpen = p::inRandomOrder()->paginate(5);
    	return view('thread')->with(compact('vk','vj','rk','randoc','randpen','randart'));
    }
    ...
    public function editkonsul($slug)
    {
        ...
        $randoc = u::inRandomOrder()->paginate(2);
        $randpen = p::inRandomOrder()->paginate(5);
            return view('editkonsul')->with(compact('ek','kc','randart','randoc','randpen')); 
        }
        else {
